            ...
            <div class="wpcmsdev-columns">
                <div class="column column-width-one-half">
                    ...
                    <form class="wpcf7" method="post" action="contact.php" id="contactform">
                        <div class="form">
                            <p><input type="text" name="name" placeholder="Nom et prénom *"></p>
                            <p><input type="text" name="email" placeholder="Adresse E-mail *"></p>
                            <p><input type="text" name="text" placeholder="Téléphone *"></p>
                            <p><textarea name="comment" rows="3" placeholder="Message *"></textarea></p>
                            <input type="submit" id="submit" class="clearfix btn" value="Envoyez">
                        </div>
                    </form>
                    <div class="done">
